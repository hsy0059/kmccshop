...
builder.Services.AddDbContext<WalletDbContext>(o => o.UseMySql(connStr, ServerVersion.AutoDetect(connStr)));
...
Campus.Common.PortHelper.FreePortIfNeeded(53224, logger);

app.UseCors();
app.UseAuthentication();
app.UseAuthorization();
app.MapControllers();
app.Urls.Add("http://0.0.0.0:53224");
app.Run();