...
builder.Services.AddDbContext<SocialDbContext>(o => o.UseMySql(connStr, ServerVersion.AutoDetect(connStr)));
...
Campus.Common.PortHelper.FreePortIfNeeded(53215, logger);

app.UseCors();
app.UseAuthentication();
app.UseAuthorization();
app.MapControllers();
app.Urls.Add("http://0.0.0.0:53215");
app.Run();