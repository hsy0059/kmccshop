...
builder.Services.AddDbContext<CampusDbContext>(o => o.UseMySql(connStr, ServerVersion.AutoDetect(connStr)));
...
Campus.Common.PortHelper.FreePortIfNeeded(53211, logger);

app.UseCors();
app.UseAuthentication();
app.UseAuthorization();
app.MapControllers();
app.Urls.Add("http://0.0.0.0:53211");
app.Run();