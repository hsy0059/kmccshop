...
builder.Services.AddDbContext<DeliveryDbContext>(o => o.UseMySql(connStr, ServerVersion.AutoDetect(connStr)));
...
Campus.Common.PortHelper.FreePortIfNeeded(53221, logger);

app.UseCors();
app.UseAuthentication();
app.UseAuthorization();
app.MapControllers();
app.Urls.Add("http://0.0.0.0:53221");
app.Run();